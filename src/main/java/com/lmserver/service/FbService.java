...
public interface FbService {
    // BM
    PagedResponse<FbBmDto> listBms(Long ownerId, int page, int size, String search, String status);
    ...
    // Account
    PagedResponse<FbAccountDto> listAccounts(Long ownerId, int page, int size, String search, Long statusId, Long bmId);
    FbAccountDto getAccountDtoById(Long id);
    ...
    // Product
    PagedResponse<FbProductDto> listProducts(Long ownerId, int page, int size, String search, String region);
